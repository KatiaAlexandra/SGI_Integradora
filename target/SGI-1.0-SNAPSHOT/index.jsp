...
<main class="form-signin w-100 m-auto">
    <form action="<%= context %>/LoginServlet" method="post">
        ...
        <div class="d-flex justify-content-between mt-3">
            <p class="mt-5 mb-3 text-muted">&copy; SGI 2024</p>
            <p data-bs-toggle="modal" data-bs-target="#cambiarContraseña" class="forgot-password" style="cursor: pointer;">Cambiar contraseña</p>
        </div>
    </form>
</main>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<%= context %>/UpdatePasswordServlet" method="post">
                    ...
                    <input type="email" class="form-control" name="emailC" id="emailC" placeholder="Ingrese el correo electrónico" required>
                    <label for="contraseñaA">Contraseña anterior</label>
