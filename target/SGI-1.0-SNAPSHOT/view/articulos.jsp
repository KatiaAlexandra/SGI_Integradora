                                        ...
                                        <tr>
                                            ...
                                            <td class="acciones">
                                                <div class="boton-modal" style="display: flex; justify-content: center;">
                                                    <div class="acciones">
                                                        <button class="btn btn-warning" onclick="putArticleInformation(<%=article.getArticle_id()%>)" data-bs-toggle="modal" data-bs-target="#actualizar">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button class="btn btn-danger" onclick="putArticleIdOnForm(<%=article.getArticle_id()%>)" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="modal-body">
                <form action="<%= context %>/UpdateArticleServlet" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="u_inventory_number" name="no_inventario" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="u_edificio" name="u_edificio">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="u_aula" name="u_aula">
                            <option value="">--Selecciona una opción--</option>
                        </select>
                    </div>
                    <div class="modal-footer">
