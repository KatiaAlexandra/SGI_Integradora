                                            ...
                                            <td>
                                                <div class="boton-modal" style="display: flex; justify-content: center;">
                                                    <div class="acciones">
                                                        ...
                                                        <button class="btn btn-danger" onclick="putManagerIdOnForm(<%=manager.getManager_ID()%>)" data-bs-toggle="modal" data-bs-target="#deleteModal">
                ...
                <form action="<%=context%>/UpdateManager" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="radio-group">
                            ...
                            <br><br>
                            <label for="u_inactivo">Inactivo</label>
